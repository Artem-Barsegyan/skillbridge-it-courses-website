...
## Основные страницы
- **Главная** (`/`) - Презентация платформы с видео, преимуществами, курсами и отзывами
- **Курсы** (`/courses`) - Полный каталог курсов по дизайну и разработке
- **Детали курса** (`/courses/:courseName`) - Подробная программа и материалы конкретного курса
- **Тарифы** (`/pricing`) - Сравнение Standard и Pro планов с переключением периодов оплаты
- **О нас** (`/about`) - История, достижения и цели платформы
- **Контакты** (`/contacts`) - Форма обратной связи и контактная информация
- **Авторизация** (`/login`, `/signup`) - Вход и регистрация
